...
CREATE TABLE IF NOT EXISTS canon_rule (
    ...
    constraints JSONB, -- 具体约束条件（用于 Validator 自动检查）
...
CREATE TABLE IF NOT EXISTS emotion_state (
    ...
    decay_rate DOUBLE PRECISION NOT NULL DEFAULT 0.1, -- 每 Scene 衰减率
...
CREATE TABLE IF NOT EXISTS scene_ledger (
    ...
    events JSONB, -- Vec<LedgerEvent>
    gains JSONB, -- Vec<LedgerItem>
    losses JSONB, -- Vec<LedgerItem>
    relationship_changes JSONB, -- Vec<RelationshipChange>
    knowledge_changes JSONB, -- Vec<KnowledgeChange>
    world_changes JSONB, -- Vec<WorldChange>
    foreshadowing_mentions JSONB, -- Vec<ForeshadowingMention>
    storyline_progress JSONB, -- Vec<StorylineProgress>
    character_growth JSONB, -- Vec<CharacterGrowth>
    created_at TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE IF NOT EXISTS decision_trace (
    ...
    factors JSONB NOT NULL, -- Vec<DecisionFactor>
    created_at TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE IF NOT EXISTS chapter_summary (
    ...
    key_events JSONB, -- Vec<String>
    involved_characters JSONB, -- Vec<Uuid>
    created_at TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE IF NOT EXISTS arc_summary (
    ...
    summary TEXT NOT NULL,
    key_turning_points JSONB, -- Vec<String>
...
CREATE TABLE IF NOT EXISTS volume_summary (
    ...
    summary TEXT NOT NULL,
    character_changes JSONB, -- Vec<String>
    world_changes JSONB, -- Vec<String>
    foreshadowing_progress JSONB, -- Vec<String>
    created_at TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE IF NOT EXISTS global_story_state (
    ...
    open_foreshadowing JSONB, -- Vec<String>
    open_storylines JSONB, -- Vec<String>
...
CREATE TABLE IF NOT EXISTS revision_plan (
    ...
    issues JSONB NOT NULL, -- Vec<RevisionIssue>
